...
RUN wget https://info-mongodb-com.s3.amazonaws.com/mongodb-bi/v2/mongodb-bi-linux-x86_64-ubuntu1804-v2.14.3.tgz
RUN tar -xvzf mongodb-bi-linux-x86_64-ubuntu1804-v2.14.3.tgz
WORKDIR /home/mongobi/mongodb-bi-linux-x86_64-ubuntu1804-v2.14.3
RUN mkdir /logs
RUN ls
RUN echo $PATH
